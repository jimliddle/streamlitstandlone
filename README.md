...
pyinstaller --onedir --add-data="<your script name>:." --add-data="<path to streamlit static direct in the virtual env>:streamlit/static" --additional-hooks-dir=hooks --copy-metadata streamlit --copy-metadata pydeck --hidden-import=<any modules a build fails to find> --hidden-import=<add as many as needed> --hidden-import=streamlit.runtime.scriptrunner.magic_funcs --hidden-import=streamlit-options-menu run_streamlit.py
